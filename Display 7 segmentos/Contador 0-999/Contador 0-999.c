...
short unidades,decenas,centenas,time;//declaramos variables
void main() {
...
centenas=0;
 while(1){  //Ciclo infinito para imprimir permanentemente  --->
  ...
  if(time>10){  // a hacer algo al programa en lo que cumple la condicion, en este caso imprimimos los datos.
